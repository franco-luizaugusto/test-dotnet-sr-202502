...
public sealed class CandidateUpdatedEventHandler : INotificationHandler<CandidateUpdatedEvent>
{
    private readonly IUnitOfWork _uow;

    public CandidateUpdatedEventHandler(IUnitOfWork uow) => _uow = uow;
    ...
    public Task Handle(CandidateUpdatedEvent notification, CancellationToken cancellationToken) =>
        _uow.Timelines.AddAsync(
            new Timeline(
                ...
                idTimelineType: (byte)TimelineTypes.Update,
